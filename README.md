...
I wrote most of the code in this project myself and used Claude AI primarily for brainstorming on evals design, debugging, and help accessing the Wikipedia API. You can see the full transcript of my chat with Claude AI during this project [here](https://claude.ai/share/43b416d7-04c2-4b35-9ecb-89be83a9ce6f).
